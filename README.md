...
===========================
 jeasypoi功能如同名字easy,主打的功能就是容易,让一个没见接触过poi的人员
...
几个工程的说明
---------------------------
	1.jeasypoi 父包--作用大家都懂得
	2.jeasypoi-annotation 基础注解包,作用与实体对象上,拆分后方便maven多工程的依赖管理
	3.jeasypoi-base 导入导出的工具包,可以完成Excel导出,导入,Word的导出,Excel的导出功能
	4.jeasypoi-web  耦合了spring-mvc 基于AbstractView,极大的简化spring-mvc下的导出功能
...
[JEasyPoi 在spring mvc中简易开发方式](http://note.youdao.com/share/?id=8b04c4d88a0574a59aeaffd142c8e34b&type=note)

[JEasyPoi-新版自定义导出样式类型](http://note.youdao.com/share/?id=7937a9fe15f1016b8f39bf813be894f8&type=note)

[JEasyPoi-标签-模板导出的语法介绍](http://blog.csdn.net/qjueyue/article/details/45231801)

[JEasyPoi-Excel预览](http://blog.csdn.net/qjueyue/article/details/45620931)
